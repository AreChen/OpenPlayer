...
[下载安装包](https://github.com/AreChen/OpenPlayer/releases/latest) · [发布说明](docs/releases/v1.2.1.md) · [许可证](LICENSE)
...
- 🐧 Linux：`OpenPlayer_1.2.1_amd64.deb` 和 `OpenPlayer_1.2.1_amd64.AppImage`
- 🍎 macOS：`OpenPlayer_1.2.1_arm64.dmg` 和 `OpenPlayer_1.2.1_x64.dmg`
