...
[Download](https://github.com/AreChen/OpenPlayer/releases/latest) · [Release Notes](docs/releases/v1.3.0.md) · [License](LICENSE)
...
- 🏷️ `v1.3.0`
- 🪟 Windows: `OpenPlayer_1.3.0_x64-setup.exe`
- 🐧 Linux: `OpenPlayer_1.3.0_amd64.deb` and `OpenPlayer_1.3.0_amd64.AppImage`
- 🍎 macOS: `OpenPlayer_1.3.0_arm64.dmg` and `OpenPlayer_1.3.0_x64.dmg`
