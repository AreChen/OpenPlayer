...
#[serde(rename_all = "camelCase")]
struct PluginNetworkRequestArgs {
    url: String,
...
fn plugin_network_request_url(value: &str) -> Result<reqwest::Url, String> {
...
fn plugin_network_request_method(value: Option<&str>) -> Result<reqwest::Method, String> {
...
#[tauri::command]
async fn plugin_network_request(
